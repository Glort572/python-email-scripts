...
if input() == 'y':
    ...
    _, search_data =client.search(None, 'NOT FROM nicola.buso@conts.it', 'SINCE "11-NOV-2023"') # you can replace 'ALL' with... see examples here: https://www.thepythoncode.com/article/deleting-emails-in-python
